...
export const commandsEmbeds = {
    1: new EmbedBuilder()
        ...
        .setTitle('Commands')
        .addFields({ name: '/commands', value: 'Brings this embed up.' }, {
    ...
    }, { name: '/dougboard', value: 'Who has been dougged the most?' }, { name: '/gold', value: `Claim ${GOLD_CLAIM_AMOUNT}${gold} - 60 minute cooldown.` }, {
...
export function getCommandsEmbedPage(pageNumber) {
