...
const command = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName('prompt').setDescription('Enter any prompt').setRequired(true))
        .addBooleanOption((option) => option
        .setName('usedoug')
        .setDescription('OPTIONAL (default is true): set to false to use contextless 3.5-Turbo.')),
    async execute(interaction) {
        ...
        await interaction.followUp(response.content.slice(0, 2000));
    },
};
